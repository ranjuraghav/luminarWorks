...
var myCountries=[]  //object to array
...
// console.log(`countryname${countryName} population ${population} capital${capital} cur${currencyName}`);    //<- variable level

// object level
// let cntrydata = { countryName: countryName, population: population, 
//   currencyName: currencyName, capital: capital 
// }
// console.log(cntrydata);    <--object data

// object to array
let cntrydata = {countryName,population,currencyName, capital }
myCountries.push(cntrydata)
}
// console.log(myCountries);

// print countryname
for (let data of myCountries){
  console.log(data.countryName);
}
myCountries.forEach(data=>console.log(data.countryName))     //foreach is used for mapping one by one

// print details of india
// let indiadata=myCountries.find(data=>data.countryName=="India")
// console.log(indiadata);

// print chinese currency
// let chinaCurrency=myCountries.find(data=>data.countryName=="China").currencyName
// console.log(chinaCurrency);